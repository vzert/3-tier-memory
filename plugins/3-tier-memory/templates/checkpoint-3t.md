...
1. **Si el propio usuario o la sesion ya dijeron UN SOLO numero de dias o semanas, o UNA SOLA
   ...
   cuenta aqui — `_revisar` solo acepta futuro (ver el aviso mas arriba sobre `_revisar` vencido)
   — cae en la regla 2. **Cualquier otra forma — mas de un numero mencionado ("3 o 7 dias segun
   X"), una condicion ("si sigue igual, en una semana"), o un rango— tampoco cuenta como "un
   numero ya dicho": cae en la regla 2.**
