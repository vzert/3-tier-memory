...
## [2.29.0] - 2026-09-19
Origen: un caso real de `claude-vzert` el 2026-09-19. El pendiente `p-3f328c3bca` pedia
"comprobar el 2026-09-20 que 7 code maps salieron del codigo actual"; a media sesion esa
...
- **Arreglo lateral, no silencioso — las 7 expresiones que despojan metadatos ahora son la MISMA
  ...
  148).
- **`bin/test-pendiente-update.sh` (nuevo)**: 46 comprobaciones. Los tres primeros casos no
